...
//New Bot constructor
func New(tbotSettings tb.Settings, faceConf wssface.Configuration, visionConf wssvision.Configuration, textAnalyticsConf wsssentiment.Configuration) (*Bot, error) {
